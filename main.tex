...
Firstly, we can safely state that for the side length of the square to be maximised, more than 1 vertice of the square must coincide with the perimeter of the polygon. This can be easily seen, as if less than 2 vertices of the square touch the perimeter of the polygon, the square can be pushed outwards in the other direction.

Also, due to such a polygon being symmetrical both horizontally and vertically, we can assume that the centre of the polygon coincides with the centre of the square.
From the observation earlier, we assume that one vertice of the square, named $A$, lies on the perimeter of the polygon.
