...
\begin{align*}
	\angle AMB\ & =\ \frac{360^{\circ}}{n}\      \\
	l^{2}+l^{2}-2\left(l\right)\left(l\right)\cos\left(\angle AMB\right) & =k^{2}    \\
	2l^{2}\left(1-\cos\left(\angle AMB\right)\right)\ & =k^{2}           \\
	l^{2} & =\frac{k^{2}}{2\left(1-\cos\left(\frac{360^{\circ}}{n}\right)\right)}   \\
	l\ & =\ k\sqrt{\frac{1}{2\left(1-\cos\left(\frac{360^{\circ}}{n}\right)\right)}}    \\
\end{align*}
...
\begin{align*}
  2s^{2} & = \left(2l\right)^{2}    \\
	s^{2} & = 2l^{2}   \\
	s & = l\sqrt{2}    \\
	& = k\sqrt{\frac{2}{2\left(1-\cos\left(\frac{360^{\circ}}{n}\right)\right)}} \\
	& = k\sqrt{\frac{1}{\left(1-\cos\left(\frac{360^{\circ}}{n}\right)\right)}} \\
\end{align*}
