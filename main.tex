...
\begin{align*}
	 x = \frac{\theta + 90^{\circ}}{\frac{\ang{360}}{n}}
\end{align*}
...
\begin{align*}
	...
	& = k\sqrt{\frac{1}{1 - \cos\frac{360^{\circ}}{n}}}
\end{align*}

\subsection{Case 2}
This case deals with the scenario where the number of sides in the $n$-gon is divisible by $2$ but not $4$.

Similar to case 1, more than one vertex of the square must coincide with the perimeter of the $n$-gon.
...
It can be seen that point $B$ is in triangle $V_{m+1}OV_{m+2}$, and is closer to $V_{m+2}$ than $V_{m+1}$.
We can now check for equality between $OA$ and $OB$, as this would render $ABCD$ as a square.
...
\begin{align*}
	OA & = \frac{r \cos \frac{180^{\circ}}{n}}{\cos \left(\frac{180^{\circ}}{n} - \frac{90^{\circ}}{n}\right)}  \\
	& = \frac{r \cos \frac{180^{\circ}}{n}}{\cos \frac{90^{\circ}}{n}}  \\
	s & = OA\sqrt{2} \\
	& = \frac{r \sqrt{2} \cos \frac{180^{\circ}}{n}}{\cos \frac{90^{\circ}}{n}}  \\
	2r^2 \left(1 - \cos \frac{360^{\circ}}{n}\right) & = k^2  \\
	r & = k\sqrt{\frac{1}{2 - 2\cos\frac{360^{\circ}}{n}}}  \\
	s & =\frac{k\sqrt{\frac{1}{2 - 2\cos\frac{360^{\circ}}{n}}} \sqrt{2} \cos \frac{180^{\circ}}{n}}{\cos \frac{90^{\circ}}{n}}  \\
	& = \frac{k\sqrt{\frac{1}{1 - \cos\frac{360^{\circ}}{n}}} \cos \frac{180^{\circ}}{n}}{\cos \frac{90^{\circ}}{n}}
\end{align*}
